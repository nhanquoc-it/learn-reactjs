// Các thuộc tính PropTypes có trong thư viện :
...
MyComponent.propTypes = {
    ...
    - Nó sẽ trả về một đối tượng Error nếu xác nhận thất bại. 
    - Trình xác nhận sẽ được gọi cho mỗi khóa trong mảng hoặc đối tượng. 
    - Hai cái đầu tiên đối số của trình xác nhận là chính mảng hoặc đối tượng và khóa hiện tại của mục.
  */
